...
('ACTUALIZACION_RUNTIME_EJECUCION_PERFIL_LF','POL-LF-OPERATION-LIFECYCLE','GOVERNANCE_LIFECYCLE',true,array['ROUTER','DIRECT'],'ACTIVE','EXEC-RUNTIME-UPDATE-REENABLE-20260919-001','EXEC-RUNTIME-UPDATE-REENABLE-20260919-001'),
('ACTUALIZACION_RUNTIME_EJECUCION_PERFIL_LF','POL-LF-POLICY-CONSUMPTION','POLICY_CONSUMPTION',true,array['ROUTER','DIRECT'],'ACTIVE','EXEC-RUNTIME-UPDATE-REENABLE-20260919-001','EXEC-RUNTIME-UPDATE-REENABLE-20260919-001'),
('ACTUALIZACION_RUNTIME_EJECUCION_PERFIL_LF','POL-LF-SOURCE-RESOLUTION','SOURCE_RESOLUTION',true,array['ROUTER','DIRECT'],'ACTIVE','EXEC-RUNTIME-UPDATE-REENABLE-20260919-001','EXEC-RUNTIME-UPDATE-REENABLE-20260919-001'),
('ACTUALIZACION_RUNTIME_EJECUCION_PERFIL_LF','POL-LF-STATE-MODEL','STATE_MODEL',true,array['ROUTER','DIRECT'],'ACTIVE','EXEC-RUNTIME-UPDATE-REENABLE-20260919-001','EXEC-RUNTIME-UPDATE-REENABLE-20260919-001');
