...
-- PR122 / M12 post-merge governance reconciliation.
-- The PR122 merge intentionally replaced r8_continuous_audit.py with the
-- versioned dispatcher that preserves the historical auditor and resolves J11
-- from the candidate manifest. The repository-governance bundle is append-only,
-- so record a new approved revision instead of rewriting historical revision 7.
...
values (
  ...
  'bed17e3e4f89dd68ba93872a03123236eef9d101b5c8ead85ff1dfa8193c1973',
  '3e8a5bc0ce6dd9851591fa63378cdb104e4f9a2e',
  'VALIDATOR',
  true,
  '0deeb8f918a4bdde5e09bc24624e91e2d61008e3',
  'WORK-PR122-M12-POSTMERGE-GOVERNANCE-20260810'
);
