...
BEGIN
  ...
  v_worker_fast:=replace(v_worker_def,$$fn_input_governance_worker_spec(p_pantalla_id integer, p_consumer text DEFAULT 'STORY_CREATOR'::text)$$,$$fn_input_governance_worker_spec_known_no_current_v1(p_pantalla_id integer, p_consumer text, p_no_current_proven boolean)$$);
  ...
  IF v_execute_sha <> 'ad3dbd95c1e90002b72eac0179590a790205d0669bce97f469a088a344b4d1f1' THEN RAISE EXCEPTION 'INPUT_GOVERNANCE_EXECUTE_BASELINE_SHA_MISMATCH:%',v_execute_sha; END IF;
