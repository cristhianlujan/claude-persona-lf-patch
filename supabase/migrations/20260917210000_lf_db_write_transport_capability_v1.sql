...
-- Supersedes the unapplied source retired by PR #883; fixes GENERATED ALWAYS handling only.
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE execution_id=v_execution_id
      ...
      AND target_path='supabase/migrations/20260917210000_lf_db_write_transport_capability_v1.sql'
