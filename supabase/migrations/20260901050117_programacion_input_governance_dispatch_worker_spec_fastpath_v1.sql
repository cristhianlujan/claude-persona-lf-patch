...
begin
  ...
  v_new:=replace(v_def,'v_worker:=programacion.fn_input_governance_worker_spec(p_pantalla_id,p_consumer);','v_worker:=programacion.fn_input_governance_worker_spec_known_current_v1(p_pantalla_id,p_consumer,v_run);');
  execute v_new;
end;
$migration$;