-- Emergency restoration after S28 exact-version canary rollback path failure.
-- Executes the exact source-guarded rollback logic from Git PR558 without claiming exact-version 20260906211600 ran.
do $rollback$
declare
  v_def text;
  v_back text;
