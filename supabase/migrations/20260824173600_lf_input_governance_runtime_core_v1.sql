...
begin
  ...
  loop
    ...
    -- Rebind only after the successor assessment has declared its governed source_refs.
    -- Any mismatch raises and rolls back the whole Curator transaction.
...
-- Full Curator -> Validator -> COMPLETED runtime probe, rolled back intentionally.
do $selftest$
declare
  b_count bigint;
  b_max bigint;
