...
begin
  ...
  values
    ...
    ('ORQUESTACION_PIPELINE_LF','MINI_JUDGE_ACT0058_RETRY','supabase://public/lf_operation_step_contracts/ORQUESTACION_PIPELINE_LF/failed_retry',null,'["retry_count_lt_3_and_stage_status_pending","retry_count_gte_3_and_stage_status_failed"]','["retry_count_gte_3_and_stage_status_not_failed"]','["RETRY_ALLOWED","RETRY_TERMINAL_FAILED","RETRY_BLOCKED"]','CANDIDATO_READ_ONLY',v_execution_id,v_execution_id);
