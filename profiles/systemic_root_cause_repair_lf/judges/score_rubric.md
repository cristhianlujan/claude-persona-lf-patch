...
3. Alternative/disposition quality — for repair candidates, materially distinct options, tradeoffs and `¿DEBE EXISTIR?`; for `NO_REPAIR_REQUIRED`, exact currentness/materiality proof and absence of invented repair work.
