...
## Visual output note
When the next step is image generation or UI mockup rendering, `prompt_constraints` must include enough visual acceptance criteria to preserve layout, hierarchy, legibility, states and forbidden visual drift. Do not create a separate visual layer for this requirement.
