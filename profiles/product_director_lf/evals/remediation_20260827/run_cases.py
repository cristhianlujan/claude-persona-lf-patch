...
def run():
    ...
    print(json.dumps({'suite':'PRODUCT_DIRECTOR_LF_REMEDIATION_20260827','passed':passed,'total':len(cases),'cases':[{'case':n,'ok':ok,'expected':exp} for n,ok,exp in cases]},ensure_ascii=False,indent=2))
