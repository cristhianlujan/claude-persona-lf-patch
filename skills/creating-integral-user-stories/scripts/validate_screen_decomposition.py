...
def positive() -> dict[str, Any]:
    return {
        ...
        "screen_decomposition": {
            ...
            "context_inventory": [{"code": "C1", "description": "search", "source_ref": "S1"}],
            "field_inventory": [],
            "permission_inventory": [{"permission_code": "P1", "actor_profile": "A", "action_code": "SEARCH", "source_ref": "S2"}],
            "transition_inventory": [{"from": "I", "action": "SEARCH", "to": "R", "allowed": True, "source_ref": "S3"}],
            "functional_units": [{"functional_unit_code": "FU-X", "actor": "Operator", "goal": "search customer", "trigger": "submit", "observable_output": "customer result", "risk_level": "LOW", "decision": "CREATE_STORY", "justification": "independent result", "source_ref": "S4", "classification": "CONFIRMED"}],
            "coverage_items": [
                {"source_item_code": "I1", "source_type": "CONTEXT", "source_ref": "S1", "mapping_status": "MAPPED", "mapped_to": ["FU-X"], "justification": "mapped"},
                {"source_item_code": "I2", "source_type": "PERMISSION", "source_ref": "S2", "mapping_status": "MAPPED", "mapped_to": ["FU-X"], "justification": "mapped"},
                {"source_item_code": "I3", "source_type": "TRANSITION", "source_ref": "S3", "mapping_status": "MAPPED", "mapped_to": ["FU-X"], "justification": "mapped"},
            ],
