...
def adapt_real_rerun_receipt_v4(
    ...
    packet = {
        "human_review_ready": bool(result.get("human_review_ready")),
        "screen_summary": {
            "visual_fidelity_result": result.get("result")
            or technical_packet.get("technical_gate_result"),
        ...
        "technical_gate_result": technical_packet.get("technical_gate_result"),
...
<title>P0 Visual Human Review V4 · __TITLE__</title>
<style>
...
<body>
<header id="app-header" class="app-header"><div class="header-grid"><div><div class="brand-kicker">P0 VISUAL HUMAN REVIEW V4</div><div id="header-screen" class="screen-name"></div></div><div><div class="header-label">Review ID</div><div id="header-review" class="header-value"></div></div><div><div class="header-label">HEAD (Git)</div><div id="header-head" class="header-value mono"></div></div><div><div class="header-label">Resultado máquina</div><div id="header-result" class="header-value"></div></div></div></header>
