#!/usr/bin/env python3
"""Verify exact P0 inventory across V1/V2/V3, executable gates and legacy readability."""
...
def main()->int:
 base=json.loads(MANIFEST.read_text());ext=json.loads(EXT_MANIFEST.read_text());v3=json.loads(V3_MANIFEST.read_text());declared=declared_rows(base,ext,v3)
 actual=[];symlinks=[];manifest_paths={MANIFEST,EXT_MANIFEST,V3_MANIFEST}
