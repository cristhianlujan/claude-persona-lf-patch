...
READER=ROOT/'scripts/p0_full_reader_v4.py'
...
def main():
 produced=produced_keys(READER);consumed={'element':set(),'candidate':set()};by_file={}
 for path in GRADERS:
