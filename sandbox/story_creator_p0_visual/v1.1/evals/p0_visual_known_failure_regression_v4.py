...
def main():
 ...
 print(json.dumps({'gate':'PASS_V4_HUMAN_FINDINGS_AS_REGRESSIONS','checks':len(checks),'known_classes_detected':8,'unseen_holdout_detected':1,'restores':1,'results':checks},sort_keys=True));return 0
