...
MIGRATION = ROOT / "supabase" / "migrations" / "20260817001000_lf_p0_canonical_human_review_single_renderer_v1.sql"
...
def main() -> int:
    ...
    # Frozen canonical structure: no redesign is permitted by presentation-only changes.
    ...
    # Persistence must fail closed instead of copying stale/simplified HTML.
    ...
    # The sole materializer fetches the frozen Git renderer and applies semantics after rendering.
    ...
    # Permanent web serving path must reject noncanonical objects.
