...
def build_gate_proofs(*,source_sha:str,head:str,config_sha:str)->tuple[dict,dict,dict,dict]:
 ...
 atomic=execute_gate('evals/p0_visual_known_failure_regression_v4.py',lambda x:x.get('gate')=='PASS_V4_HUMAN_FINDINGS_AS_REGRESSIONS' and x.get('atomic_segmentation_defended') is True and x.get('strict_fallback_defended') is True and x.get('sweep_corroboration_defended') is True)
