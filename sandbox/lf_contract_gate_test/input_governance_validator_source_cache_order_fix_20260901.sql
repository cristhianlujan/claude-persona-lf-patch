-- Source-first fix for PostgreSQL 42P10 in the run-local unique source_ref cache.
-- Cache semantics are unchanged; ordering of unique cache population is irrelevant.
