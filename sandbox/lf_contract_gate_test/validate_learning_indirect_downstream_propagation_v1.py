...
def main():
 ...
 if product.get('consumer_id')!='PERFIL-PRODUCT-DIRECTOR-LF' or ui.get('consumer_id')!='PERFIL-UI-ARCHITECT': fail('direct identities')
 ...
 if game.get('consumer_id')!='PERFIL-GAMIFICATION-SYSTEM-ARCHITECT': fail('gamification identity')
 ...
 if 'competitive_kb_rows' not in (game.get('must_not_receive') or []): fail('gamification KB leak')
 r=d.get('rules') or {}
 ...
 print('LEARNING_DOWNSTREAM_PROPAGATION=PASS direct_consumers=2 indirect_frontend=ACT-0051 indirect_gamification=PERFIL-GAMIFICATION-SYSTEM-ARCHITECT extra_learning_llm=0 production=0')
 return 0
