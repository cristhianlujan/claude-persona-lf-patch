...
- Canonical result contract: `gobernanza/contratos/pack_validation_result.schema.json`.
- Floor shape contract: `gobernanza/contratos/pack_validation_floor.schema.json`.
...
This source PR is intentionally not the authority cutover.
