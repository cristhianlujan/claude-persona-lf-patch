...
EXPECTED_MANIFEST_SHA256 = "a3258504bb1fcfe3c3aed20cfa1cde64438679f1834dd638cb3cca92d9f64cb6"
EXPECTED_OWNER = "S30"
EXPECTED_BRANCH = "s30-repository-change-lf-20260914"
...
def main() -> int:
    ...
    print(json.dumps({"status":"PASS","scope":"S30_REPOSITORY_CHANGE_ONLY","anchor":anchor,"merge_base":merge_base,"owned_head":branch_head,"changed_path_count":len(changed),"manifest_sha256":observed}, sort_keys=True))
    return 0
