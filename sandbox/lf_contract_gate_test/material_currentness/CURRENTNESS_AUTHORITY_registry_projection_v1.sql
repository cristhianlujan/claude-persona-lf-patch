...
values (
  'CURRENTNESS_AUTHORITY','1.0.0',1,0,0,'RELEASED_CANDIDATE',null,
  jsonb_build_object(
    ...
    'durable_evidence_anchor_required_before_authoritative_cutover',true
  ),
  '3f4f585aa3c6f760d9c8fcaef7233c318dc68316cc4a2e6c7a79cebd95fc01e5',
...
-- The canonical migration lifecycle must replace the source revision placeholder,
-- verify this exact manifest SHA256, verify execution provenance, and only then
-- use the existing promotion/binding APIs.
