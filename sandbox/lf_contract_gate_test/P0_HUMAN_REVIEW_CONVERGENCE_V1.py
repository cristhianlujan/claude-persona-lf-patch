...
parent, then runs the isolated OCR accuracy and selective-challenger latency
experiments with auditable result capture. This wrapper MUST NOT be merged.
"""
...
LATENCY = Path(__file__).with_name("P0_DUAL_OCR_LATENCY_MODEL_MANIFEST_V1.py")
...
def main() -> int:
    ...
    run([sys.executable, str(LATENCY)])
    print("PASS_DUAL_OCR_EXECUTION_WRAPPER=2/2")
    return 0
