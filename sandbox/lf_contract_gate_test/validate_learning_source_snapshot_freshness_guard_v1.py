...
req(set(D['fresh_readback_required_for'])=={'NEW_EXACT_BINDING','NEW_CONTEXT_PACK_WITH_EVIDENCE','NEW_LEARNING_ADMISSION','RUNTIME_STATE_CHANGE','CARD_CREATION_DECISION'},'FRESH_SCOPE')
...
print('LEARNING_SOURCE_SNAPSHOT_FRESHNESS_GUARD=PASS snapshots=3/3 new_binding_requires_fresh_readback=true production_authorized=false')
