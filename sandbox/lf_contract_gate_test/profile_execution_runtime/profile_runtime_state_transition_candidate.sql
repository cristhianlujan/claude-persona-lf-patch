...
values (
  'CANDIDATO_CONTROLADO_READ_ONLY',
  'CANDIDATO',
  'READ_ONLY',
  'CONTROLADO',
  'CANDIDATE_READ_ONLY',
...
values (
  ...
  'PERFIL',
  'GPT-STRATEGY26-GA-TRANSITION-SANDBOX-20260905-001'
)
...
(
 ...
 'public.v_lf_fuente_operativa.ACT-0001',
 '["router_read","profile_code"]'::jsonb,
 '{"required_evidence_keys":["router_read","profile_code"]}'::jsonb,
 '{"missing_required_evidence":true,"ambiguous_profile":true}'::jsonb,
 'BLOCK_PROFILE_RUNTIME_TRANSITION_ROUTER_NOT_CLEAN',
 'DETERMINISTIC_STATE_TRANSITION_CANDIDATE',
 '["router_read","profile_code"]'::jsonb,'source_state_read','RETURN_TO_ROUTER','CANDIDATO_READ_ONLY',
 'Sandbox candidate. No state write from this step.',
 'GPT-STRATEGY26-GA-TRANSITION-SANDBOX-20260905-001'
),
(
 'TRANSICION_RUNTIME_PERFIL_READ_ONLY_LF','source_state_read',20,20,
 'CONTRACT-TRANSICION-RUNTIME-PERFIL-READ-ONLY-LF-v0.1-candidate',
 'Read the exact four-dimensional source state from v_lf_fuente_operativa.',
 ...
 'BLOCK_PROFILE_RUNTIME_TRANSITION_SOURCE_STATE_MISMATCH',
 'DETERMINISTIC_STATE_TRANSITION_CANDIDATE',
 '["source_state"]'::jsonb,'target_state_validate','RETURN_TO_ROUTER','CANDIDATO_READ_ONLY',
 'Fail closed on any source-state drift.',
 'GPT-STRATEGY26-GA-TRANSITION-SANDBOX-20260905-001'
),
(
 'TRANSICION_RUNTIME_PERFIL_READ_ONLY_LF','target_state_validate',30,30,
 'CONTRACT-TRANSICION-RUNTIME-PERFIL-READ-ONLY-LF-v0.1-candidate',
 'Require exact canonical target tuple in cat_estado_normalizacion_lf.',
 'public.cat_estado_normalizacion_lf',
 '["target_state_catalog_match"]'::jsonb,
 ...
 'BLOCK_PROFILE_RUNTIME_TRANSITION_TARGET_STATE_NOT_CANONICAL',
 'DETERMINISTIC_STATE_TRANSITION_CANDIDATE',
 '["target_state_catalog_match"]'::jsonb,'controlled_write','RETURN_TO_ROUTER','CANDIDATO_READ_ONLY',
 'Catalog registration is a prerequisite, not inferred authority.',
 'GPT-STRATEGY26-GA-TRANSITION-SANDBOX-20260905-001'
),
(
 'TRANSICION_RUNTIME_PERFIL_READ_ONLY_LF','controlled_write',40,40,
 'CONTRACT-TRANSICION-RUNTIME-PERFIL-READ-ONLY-LF-v0.1-candidate',
 'Change runtime_estado only to CANDIDATE_READ_ONLY for the single bound profile while preserving CANDIDATO/READ_ONLY/BLOQUEADO.',
 'DETERMINISTIC_SUPABASE_STATE_TRANSITION_CANDIDATE',
 '["transition_receipt","before_state","after_state"]'::jsonb,
 ...
 'BLOCK_PROFILE_RUNTIME_TRANSITION_WRITE_NOT_BOUNDED',
 'DETERMINISTIC_STATE_TRANSITION_CANDIDATE',
 '["transition_receipt","before_state","after_state"]'::jsonb,'readback','RETURN_TO_ROUTER','CANDIDATO_READ_ONLY',
 'No execution_sql is provided while the operation remains sandbox candidate.',
 'GPT-STRATEGY26-GA-TRANSITION-SANDBOX-20260905-001'
),
(
 'TRANSICION_RUNTIME_PERFIL_READ_ONLY_LF','readback',50,50,
 'CONTRACT-TRANSICION-RUNTIME-PERFIL-READ-ONLY-LF-v0.1-candidate',
 'Verify the same profile remains CANDIDATO/READ_ONLY/BLOQUEADO and becomes only CANDIDATE_READ_ONLY; then Router may be re-evaluated separately.',
 'public.v_lf_fuente_operativa',
 '["exact_state_readback","router_post_transition_readback","automatic_impact_still_blocked"]'::jsonb,
 ...
 'BLOCK_PROFILE_RUNTIME_TRANSITION_READBACK_FAILED',
 'DETERMINISTIC_STATE_TRANSITION_CANDIDATE',
 ...
 'Closure requires independent readback. R4 remains a separate later gate.',
 'GPT-STRATEGY26-GA-TRANSITION-SANDBOX-20260905-001'
)
