...
def build_bound_governance_receipt(router_result: dict[str, Any], *, request_id: str, profile_code: str, input_literal: str, governance_consumer: str = "CONTEXT_PACK") -> dict[str, Any]:
    ...
    bound = {"schema": SCHEMA,"request_id": request_id,"profile_code": profile_code,"governance_consumer": governance_consumer,"input_sha256": _sha256_text(input_literal),"source_snapshot_sha256": snapshot_hash,"contract_snapshot_sha256": contract_snapshot_hash,"run_id": receipt["run_id"],"pantalla_id": receipt["pantalla_id"],"screen_code": screen_code,"decision": "PASS","currentness": "LIVE_CURRENT","governance_receipt_sha256": _canonical_sha256(receipt),"governance_receipt": receipt}
    bound["binding_sha256"] = _canonical_sha256(bound)
    return bound

def validate_bound_governance_receipt(bound: dict[str, Any], *, request_id: str, profile_code: str, input_literal: str, governance_consumer: str = "CONTEXT_PACK") -> dict[str, Any]:
    if governance_consumer not in ALLOWED_GOVERNANCE_CONSUMERS:
        raise GovernanceBindingError("INPUT_GOVERNANCE_CONSUMER_NOT_ALLOWED")
    ...
    expected = {"request_id": request_id,"profile_code": profile_code,"governance_consumer": governance_consumer,"input_sha256": _sha256_text(input_literal),"decision": "PASS","currentness": "LIVE_CURRENT"}
    ...
    unhashed = dict(bound); unhashed.pop("binding_sha256", None)
