...
migration ledger before the existing DB_WRITE_TRANSPORT Git persistence
transport is allowed to create a repair branch. No DDL is replayed and no merge
is performed.
"""
...
def main() -> int:
    ...
    for version in versions:
        ...
        results.append({
            ...
            "post_repair_check": "lf-contract-check/MIGRATION_SOURCE_PARITY",
        })
    print(json.dumps({"status": "REPAIR_DISPATCHED", "schema_version": "lf-migration-source-parity-repair/v1", "repairs": results}, sort_keys=True, separators=(",", ":")))
    return 0
