...
for i,b in enumerate(D['bindings']):
    ...
    req(b['consumer_type']=='PROFILE',f'TYPE_{i}')
    req(b['router_action']=='EJECUCION_PERFIL_LF',f'ROUTER_{i}')
...
print('LEARNING_ADDITIONAL_CONSUMER_BINDING_CANDIDATES=PASS candidates=4/4 mandatory_fields=22/22 active_exact_bindings=0 context_delivery=false lifecycle=READY_FOR_BINDING')
