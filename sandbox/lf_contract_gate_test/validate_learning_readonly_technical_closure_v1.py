...
if D['status']=='VERIFICATION_IN_PROGRESS':
    ...
    print('LEARNING_READONLY_TECHNICAL_CLOSURE=PASS_FAIL_CLOSED status=VERIFICATION_IN_PROGRESS reader_exact_join=50/50 active_bindings=7/7 specialized=HARDENED production_authorized=false')
