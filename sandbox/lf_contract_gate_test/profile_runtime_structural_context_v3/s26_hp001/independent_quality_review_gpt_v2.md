# S26 HP001 — Independent GPT Quality Review Handoff v2

## Execution boundary

Run this review in a **fresh independent chat/context** that did not produce or repair S26 HP001.
...
- do not read any Claude receipt or prior semantic verdict
- do not repair the artifact while reviewing it
- no paid external model/API call and no model-weight download
- return **one JSON object only**

This review is semantic. Deterministic validation of the returned receipt is performed by the integrator **after** the reviewer returns it. Lack of a local Python/shell runtime is therefore not a review blocker.
...
The same bytes are also preserved as gzip provenance at commit `f80679e08ec21d7c6c33d24188e3cb86c0b37c6d`; gzip SHA-256 is `45d32702a97a8d9141d1283cfa3065221434ae2cc9bc19f138bca61010999b2a`. Review the text JSON above; gzip decompression is not required for the reviewer.
...
The integrator, not the reviewer, will validate the receipt using the frozen official validators plus the S26 exact-binding wrapper:
...
This handoff authorizes only independent semantic review of the frozen artifact. It does **not** authorize Golden, merge, main, deployment, production, artifact mutation, or access to another reviewer receipt.