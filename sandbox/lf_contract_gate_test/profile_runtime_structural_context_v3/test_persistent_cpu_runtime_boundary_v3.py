...
assert contract['status']=='CONTRACT_DEFINED_NOT_IMPLEMENTED'
assert contract['current_github_adapter_reusable_on_persistent_host'] is False
assert contract['current_blocker_code']=='ZERO_COST_GITHUB_RUNNER_PRECONDITION_FAILED'
...
print('PERSISTENT_CPU_RUNTIME_BOUNDARY_V3_PASS 9/9')
