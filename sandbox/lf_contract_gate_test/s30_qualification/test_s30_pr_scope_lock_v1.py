...
EXPECTED_MANIFEST_SHA256 = "f4a01d76d4588bdc0a0569fe2b3b7c04d2a8757719eda0c9adf1799b17ac97c6"
EXPECTED_OWNER = "S30"
EXPECTED_BRANCH = "s30-qualification-lf-20260914"
...
def main() -> int:
    ...
    print(json.dumps({"status":"PASS","scope":"S30_QUALIFICATION_ONLY","anchor":anchor,"merge_base":merge_base,"owned_head":branch_head,"changed_path_count":len(changed),"manifest_sha256":observed}, sort_keys=True))
    return 0
