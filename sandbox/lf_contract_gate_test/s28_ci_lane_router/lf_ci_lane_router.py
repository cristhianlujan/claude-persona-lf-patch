...
S26_E_GOVERNANCE_RECEIPT_EXACT = "sandbox/lf_contract_gate_test/receipts/s26_e_governance_ekb_card_fallback.json"
...
def _is_s26_e_governance(path: str) -> bool:
    return path.startswith(S26_E_GOVERNANCE_PREFIX) or path == S26_E_GOVERNANCE_RECEIPT_EXACT
...
def classify(paths: Iterable[str]) -> LaneDecision:
    ...
    if unknown:
        ...
        mode = "S26_E_GOVERNANCE_ISOLATED"
