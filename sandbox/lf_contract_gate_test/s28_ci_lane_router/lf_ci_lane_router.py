...
S26_COMMIT_READBACK_BASE_DRIFT_CONTROL = "sandbox/lf_contract_gate_test/profile_runtime_structural_context_v3/test_s26_commit_readback_pr_merge_base_drift.py"
...
CI_SELFTEST_CONTROLS = frozenset({
    ...
    S26_COMMIT_READBACK_BASE_DRIFT_CONTROL,
})
