...
EXPECTED_MANIFEST_SHA256 = "2f26a424980cf4f0647bc154d6179ab1fc7efea7c696cfa9beaad94de36aee7c"
EXPECTED_OWNER = "S30"
EXPECTED_BRANCH = "s30-ci-evidence-lf-20260914"
...
def main() -> int:
    ...
    if lock.get("owner") != EXPECTED_OWNER or lock.get("head_branch") != EXPECTED_BRANCH or lock.get("scope") != "CI_EVIDENCE_LF":
    ...
    print(json.dumps({"status":"PASS","scope":"S30_CI_EVIDENCE_ONLY","anchor":anchor,"merge_base":merge_base,"owned_head":branch_head,"changed_path_count":len(changed),"manifest_sha256":observed}, sort_keys=True))
    return 0
