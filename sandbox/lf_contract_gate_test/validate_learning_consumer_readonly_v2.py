...
RUNTIME_GUARD_VALIDATOR=ROOT/'sandbox/lf_contract_gate_test/validate_learning_readonly_runtime_guard_reconciliation_v1.py'
RELEASE_CANDIDATE_VALIDATOR=ROOT/'sandbox/lf_contract_gate_test/validate_learning_readonly_release_candidate_v3.py'
...
def main():
 ...
 print(run(RUNTIME_GUARD_VALIDATOR))
 print(run(RELEASE_CANDIDATE_VALIDATOR))
 print('LEARNING_READONLY_MULTI_CONSUMER_GATE=PASS direct_profiles=2 downstream_profiles=2 total_profiles=4 behavioral_runtime_invoked=0 staged_sources=5 dynamic_selector_cases=50/50 dynamic_cluster_bindings=7 request_builder=PASS runtime_guard=PASS release_candidate=PASS')
 return 0
