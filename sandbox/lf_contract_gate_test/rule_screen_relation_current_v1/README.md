...
That base already contains the durable capability, its ACT-0001 controlled-production integration, and the canonical Strategy Update migration-source parity restored by PR #764.
...
PR #748 remains historical evidence only. PR #763 was the first clean current-state lane but became stale solely because `main` advanced through the independently owned Strategy Update parity merge #764. This refreshed lane supersedes #763 without importing any Strategy Update files.