-- Retry-safe readback for the governed Input Validator runtime.
-- Returns only the identity already bound to a VALIDATING run; it never mutates or rebinds identity.
