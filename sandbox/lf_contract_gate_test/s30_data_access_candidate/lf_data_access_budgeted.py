...
class BudgetedLFDataAccess:
    ...
    def execute_registered_read(self, *, prepared: Mapping[str, Any], backend: Callable[[Mapping[str, Any]], Any]) -> dict:
        ...
        for required in ("fields", "filters", "max_rows", "byte_budget", "order_by", "access_profile", "read_scope"):
            if required not in plan:
                return _block("BLOCK_BUDGETED_PLAN_INCOMPLETE", f"missing plan field={required}", backend_executed=False)
