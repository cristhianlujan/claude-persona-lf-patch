...
Capability transversal LF: `C05_GENERIC_EXECUTION_RELIABILITY` / `TRANSVERSAL_C05_GENERIC_EXECUTION_RELIABILITY`.
...
- README de consumo: `sandbox/lf_contract_gate_test/transversal_assets/c05_generic_execution_reliability/README.md`

## Propósito

Aplicar controles genéricos de confiabilidad a ejecuciones gobernadas.

## Cuándo consumirlo

Cuando una operación o estrategia declara que requiere el control C05 de confiabilidad de ejecución.
...
1. Resolver primero `C05_GENERIC_EXECUTION_RELIABILITY` en el inventario transversal; no buscar una implementación nueva antes de revisar este activo.
2. Entrar por `EJECUCION_ESTRATEGIA_LF:c05_reliability_required` o por la superficie canónica equivalente indicada por el contrato vigente.
...
- `20260911025454_s30_c05_generic_execution_reliability_v1`
- `EJECUCION_ESTRATEGIA_LF:c05_reliability_required`
...
No reemplaza validaciones funcionales del owner ni autoriza continuar si el control requerido falla.
