...
Capability transversal LF: `OPERATION_NEUTRAL_STEP_RECORDER` / `TRANSVERSAL_OPERATION_NEUTRAL_STEP_RECORDER`.
...
- README de consumo: `sandbox/lf_contract_gate_test/transversal_assets/operation_neutral_step_recorder/README.md`

## Propósito

Registrar pasos de ejecución de manera neutral al dominio y conservar evidencia/readback.

## Cuándo consumirlo

Cuando una operación gobernada necesita persistir el estado y la evidencia de un step sin crear un recorder específico.
...
1. Resolver primero `OPERATION_NEUTRAL_STEP_RECORDER` en el inventario transversal; no buscar una implementación nueva antes de revisar este activo.
2. Entrar por `public.lf_record_operation_step_core_v1` o por la superficie canónica equivalente indicada por el contrato vigente.
...
- `public.lf_record_operation_step_core_v1`
- `20260913034746_lf_card_update_i4_operation_neutral_recorder_v1`
...
No debe introducir semántica de negocio del consumidor; esa semántica pertenece al contrato/judge del step.
