...
Capability transversal LF: `VALIDATION_EXEMPTION_ONE_USE` / `TRANSVERSAL_VALIDATION_EXEMPTION_ONE_USE`.
...
- README de consumo: `sandbox/lf_contract_gate_test/transversal_assets/validation_exemption_one_use/README.md`

## Propósito

Permitir una exención de validación gobernada, scoped y consumible una sola vez.

## Cuándo consumirlo

Solo cuando exista una exención explícita válida para un caso excepcional autorizado.
...
1. Resolver primero `VALIDATION_EXEMPTION_ONE_USE` en el inventario transversal; no buscar una implementación nueva antes de revisar este activo.
2. Entrar por `private.fn_consume_lf_event_validation_exemption_v3` o por la superficie canónica equivalente indicada por el contrato vigente.
...
- `private.lf_event_validation_exemptions`
- `private.fn_guard_lf_validation_exemption_v2`
- `private.fn_consume_lf_event_validation_exemption_v3`
- `private.fn_lf_exemption_scope_matches_v3`
- `private.fn_execute_exemption_one_use_probe_v3`
...
No reutilizar una exención consumida, ampliar scope ni convertirla en bypass general.
