# QUALIFICATION_STORE_SECURITY

Capability transversal LF: `QUALIFICATION_STORE_SECURITY` / `TRANSVERSAL_QUALIFICATION_STORE_SECURITY`.
...
- README de consumo: `sandbox/lf_contract_gate_test/transversal_assets/qualification_store_security/README.md`

## Propósito

Proteger stores de qualification mediante controles de seguridad y RLS.

## Cuándo consumirlo

Al leer o escribir stores de qualification desde cualquier consumidor.
...
1. Resolver primero `QUALIFICATION_STORE_SECURITY` en el inventario transversal; no buscar una implementación nueva antes de revisar este activo.
2. Entrar por `RLS on four qualification stores` o por la superficie canónica equivalente indicada por el contrato vigente.
...
- `S30-R23`
- `RLS on four qualification stores`
...
No usar bypass directo ni service paths fuera de la autoridad prevista para el store.
