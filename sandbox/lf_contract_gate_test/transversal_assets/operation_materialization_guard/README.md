...
Capability transversal LF: `OPERATION_MATERIALIZATION_GUARD` / `TRANSVERSAL_OPERATION_MATERIALIZATION_GUARD`.
...
- README de consumo: `sandbox/lf_contract_gate_test/transversal_assets/operation_materialization_guard/README.md`

## Propósito

Verificar que una operación materializada conserve registry, steps, contratos y judges coherentes.

## Cuándo consumirlo

Al crear, actualizar o verificar una operación gobernada.
...
1. Resolver primero `OPERATION_MATERIALIZATION_GUARD` en el inventario transversal; no buscar una implementación nueva antes de revisar este activo.
2. Entrar por `public.fn_lf_operation_registry_materialization_guard_v1` o por la superficie canónica equivalente indicada por el contrato vigente.
...
- `public.fn_lf_operation_registry_materialization_guard_v1`
...
No considerar operativa una definición source-only si faltan bindings/materialización live requeridos.
