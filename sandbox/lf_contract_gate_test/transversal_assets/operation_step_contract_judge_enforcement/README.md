# OPERATION_STEP_CONTRACT_JUDGE_ENFORCEMENT

Capability transversal LF: `OPERATION_STEP_CONTRACT_JUDGE_ENFORCEMENT` / `TRANSVERSAL_OPERATION_STEP_CONTRACT_JUDGE_ENFORCEMENT`.
...
- README de consumo: `sandbox/lf_contract_gate_test/transversal_assets/operation_step_contract_judge_enforcement/README.md`

## Propósito

Exigir cobertura de contrato y judge para steps de operaciones gobernadas.

## Cuándo consumirlo

Al materializar o ejecutar steps que deben demostrar condiciones de aceptación verificables.
...
1. Resolver primero `OPERATION_STEP_CONTRACT_JUDGE_ENFORCEMENT` en el inventario transversal; no buscar una implementación nueva antes de revisar este activo.
2. Entrar por `public.v_lf_operation_step_contract_judge_coverage` o por la superficie canónica equivalente indicada por el contrato vigente.
...
Un step requerido sin contrato/judge aplicable no puede asumirse PASS.
