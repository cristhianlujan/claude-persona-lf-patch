...
Capability transversal LF: `INDEPENDENT_ASSURANCE` / `TRANSVERSAL_INDEPENDENT_ASSURANCE`.
...
- README de consumo: `sandbox/lf_contract_gate_test/transversal_assets/independent_assurance/README.md`

## Propósito

Separar la revisión independiente de la ejecución que produjo la evidencia.

## Cuándo consumirlo

Cuando una qualification, claim o cierre exige evaluación independiente y no autoevaluación del mismo productor.
...
1. Resolver primero `INDEPENDENT_ASSURANCE` en el inventario transversal; no buscar una implementación nueva antes de revisar este activo.
2. Entrar por `REVISION_INDEPENDIENTE_ESTRATEGIA_LF` o por la superficie canónica equivalente indicada por el contrato vigente.
...
- `public.lf_finalize_qualification_independent_review_v1`
...
No usar la misma autoridad/productor como sustituto de independencia cuando el contrato la exige.
