...
Capability transversal LF: `TRANSACTIONAL_EXECUTION_BEGIN` / `TRANSVERSAL_TRANSACTIONAL_EXECUTION_BEGIN`.
...
- README de consumo: `sandbox/lf_contract_gate_test/transversal_assets/transactional_execution_begin/README.md`

## Propósito

Iniciar una ejecución de estrategia dentro de un boundary transaccional gobernado.

## Cuándo consumirlo

Al comenzar una ejecución que requiere reserva/binding/estado inicial consistente antes de efectos posteriores.
...
1. Resolver primero `TRANSACTIONAL_EXECUTION_BEGIN` en el inventario transversal; no buscar una implementación nueva antes de revisar este activo.
2. Entrar por `public.lf_strategy_execution_begin_v1` o por la superficie canónica equivalente indicada por el contrato vigente.
...
- `public.lf_strategy_execution_begin_v1`
- `20260914065909_s30_strategy_execution_transactional_begin_v1`
...
No crear ejecuciones parciales fuera del begin canónico cuando el contrato exige inicio transaccional.
