...
from s38_governed_resolution_v0_3 import (
    PASS as TRUST_PASS,
    BLOCKED,
...
F_SCHEMA_REL = "sandbox/lf_contract_gate_test/s38_bootstrap/lf_common_evidence_envelope_v0_6_candidate.schema.json"
TRUSTED_RESOLVER_ID = "S38_GOVERNED_REF_RESOLVER_V3"
...
def validate_capability_manifest(value: Mapping[str, Any], resolver: EvidenceResolver | None = None) -> dict[str, Any]:
    ...
    if resolved.get("status") != PASS:
        return resolved
    return {"status": PASS, "code": "PASS_E_CAPABILITY_MANIFEST_S38_V0_6"}
...
def validate_evidence_envelope(value: Mapping[str, Any], resolver: EvidenceResolver | None = None) -> dict[str, Any]:
    ...
    return {"status":PASS,"code":"PASS_F_EVIDENCE_ENVELOPE_S38_V0_6_EARNED","earned_tier":earned,"cross_binding_sha256":expected_cross}
