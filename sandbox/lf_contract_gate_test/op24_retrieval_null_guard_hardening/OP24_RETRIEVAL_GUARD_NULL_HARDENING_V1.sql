-- OP24 Retrieval Guard NULL Hardening V1 — sandbox candidate source only.
-- MUST NOT be applied directly to production. Intended for BEGIN/ROLLBACK validation.
-- Source baseline: Supabase ledger migration 20260815143320_programacion_prog013_prog014_insert_integrity
-- Finding: OP24-RETRIEVAL-NULL-SELECTED-PAYLOAD-GUARD-001 (backlog 112).
...
begin
  ...
  -- Required JSONB carriers: SQL NULL, JSON null and wrong types all fail closed.
