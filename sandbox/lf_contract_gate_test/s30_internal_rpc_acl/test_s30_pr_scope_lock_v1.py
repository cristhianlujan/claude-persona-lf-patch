...
EXPECTED_MANIFEST_SHA256 = "48451c4cf0cdf0182b02440b88d68ae2e16ef172bb93dcef8a3f6dad6aba7f40"
EXPECTED_OWNER = "S30"
EXPECTED_BRANCH = "s30-internal-rpc-acl-hardening-20260914"
...
def main() -> int:
    ...
    print(json.dumps({"status":"PASS","scope":"S30_INTERNAL_RPC_ACL_ONLY","anchor":anchor,"merge_base":merge_base,"owned_head":branch_head,"changed_path_count":len(changed),"manifest_sha256":observed}, sort_keys=True))
    return 0
