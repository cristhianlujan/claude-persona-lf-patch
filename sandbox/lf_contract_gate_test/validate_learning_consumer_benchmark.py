...
def main():
 matrix=MATRIX.read_text(encoding='utf-8'); contract=CONTRACT.read_text(encoding='utf-8'); case_lines=[line.strip() for line in matrix.splitlines() if line.strip().startswith('- {id:')]
