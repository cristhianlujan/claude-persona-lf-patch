...
(
  'EXEC-S30-POLICY-CREATE-ISOLATED-CANARY-20260909-001',
  ...
  jsonb_build_object(
    ...
    'source_branch','lf/s30-policy-contract-isolated-20260909',
    'cross_lane_dependency_mode','OPTIONAL_REUSE_NOT_BRANCH_BASE',
    'claim_ceiling','ROLLBACK_ONLY_CANDIDATE_NO_ACTIVATION_NO_PRODUCTION'
  ),
  'EXEC-S30-POLICY-CREATE-ISOLATED-CANARY-20260909-001'
),
(
  'EXEC-S30-POLICY-UPDATE-ISOLATED-CANARY-20260909-001',
  'VULNERABILITY_COVERAGE_REPAIR_LF',
  'OPERATION_CODE',
...
(
  'CREACION_POLITICA_LF','v0.2-isolated','CANDIDATO_READ_ONLY','GIT_FIRST_YAML',
  ...
  'S30 isolated candidate. No cross-lane branch dependency. No Router ACTIVE, runtime, production or automatic promotion.',
  'GOVERNANCE','POLICY_LIFECYCLE','CREATION_PROTOCOL','REGLA',
  'EXEC-S30-POLICY-CREATE-ISOLATED-CANARY-20260909-001','EXEC-S30-POLICY-CREATE-ISOLATED-CANARY-20260909-001'
),
(
  'ACTUALIZACION_POLITICA_LF','v0.2-isolated','CANDIDATO_READ_ONLY','GIT_FIRST_YAML',
  'cristhianlujan/claude-persona-lf-patch',
  '["sandbox/lf_contract_gate_test/s30_policy_operations_candidate/policy_operations_contract.yaml","sandbox/lf_contract_gate_test/s30_policy_operations_candidate/validate_policy_operations_candidate.py","sandbox/lf_contract_gate_test/s30_policy_operations_candidate/test_policy_operations_candidate.py","sandbox/lf_contract_gate_test/s30_policy_operations_candidate/rollback_canary.sql"]'::jsonb,
  'S30 isolated candidate. Successor-only update; no cross-lane branch dependency or supersession.',
  'GOVERNANCE','POLICY_LIFECYCLE','UPDATE_PROTOCOL','REGLA',
  'EXEC-S30-POLICY-UPDATE-ISOLATED-CANARY-20260909-001','EXEC-S30-POLICY-UPDATE-ISOLATED-CANARY-20260909-001'
);
...
(
  ...
  'Isolated S30 candidate naming; not canonical until separate promotion.',
  'EXEC-S30-POLICY-CREATE-ISOLATED-CANARY-20260909-001','EXEC-S30-POLICY-CREATE-ISOLATED-CANARY-20260909-001'
),
(
