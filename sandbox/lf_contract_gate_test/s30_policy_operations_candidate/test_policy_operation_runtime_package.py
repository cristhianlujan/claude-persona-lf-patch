...
def main():
    ...
    case("cross_lane_base_enabled", lambda x: x["isolation"].__setitem__("cross_lane_branch_dependency_allowed",True), "CROSS_LANE_BRANCH_DEPENDENCY_FORBIDDEN")
    case("wrong_base", lambda x: x["isolation"].__setitem__("base_branch","lf/op24-operation-factory-candidate-20260907"), "ISOLATION_BASE_MUST_BE_MAIN")
    print("POLICY_OPERATION_RUNTIME_REGRESSIONS_PASS=11/11")
