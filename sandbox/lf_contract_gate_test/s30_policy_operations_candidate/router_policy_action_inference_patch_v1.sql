-- S30 isolated candidate-only ACT-0001 inference patch.
-- Scope: recognize explicit policy/politica language for REGLA without changing generic REGLA behavior.
-- Base lane: main. No stacked branch dependency is allowed.
-- No durable apply, runtime enablement or production authorization is implied by this source.
