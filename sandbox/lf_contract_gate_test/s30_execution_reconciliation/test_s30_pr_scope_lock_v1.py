...
EXPECTED_MANIFEST_SHA256 = "aee6cc8b6addbcf3d3d5891a91a6616d39fa6f6844131162182217ede506c542"
EXPECTED_OWNER = "S30"
EXPECTED_BRANCH = "s30-execution-reconciliation-lf-20260914"
...
def main() -> int:
    ...
    print(json.dumps({"status":"PASS","scope":"S30_EXECUTION_RECONCILIATION_ONLY","anchor":anchor,"merge_base":merge_base,"owned_head":branch_head,"changed_path_count":len(changed),"manifest_sha256":observed}, sort_keys=True))
    return 0
