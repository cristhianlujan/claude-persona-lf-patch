...
MODULE = Path("gobernanza/judges/validate_strategy_contract_v032.py")
spec = importlib.util.spec_from_file_location("validate_strategy_contract_v032", MODULE)
if spec is None or spec.loader is None:
    raise SystemExit("FAIL_S30_VALIDATOR_V032_MODULE_LOAD")
...
def expect(name: str, payload: dict, mode: str, valid: bool, code: str | None = None) -> dict:
    ...
    return {
        ...
        "results_sha256": result.get("results_sha256"),
    }
...
if failed:
    raise SystemExit("FAIL_S30_STRATEGY_CONTRACT_V032_CANARY")
print("PASS_S30_STRATEGY_CONTRACT_V032_CANARY")
